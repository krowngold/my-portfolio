...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeIgnored() {
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.WHOLE_DAY, Arrays.asList("Jeff")));

    MeetingRequest request =
        new MeetingRequest(Arrays.asList(PERSON_A, PERSON_B), DURATION_30_MINUTES);
    request.addOptionalAttendee("Jeff");
  ...
  @Test
  public void noTimeOnlyOptional() {
      Collection<Event> events = Arrays.asList(
  ...
  @Test
  public void someTimeOnlyOptional() {
      Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, 510), 
          Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, 30), Arrays.asList(PERSON_B)));
    ...
    Collection<TimeRange> actual = query.query(events, request);
    Collection<TimeRange> expected = 
      Arrays.asList(TimeRange.fromStartDuration(TIME_0830AM, 30),
        TimeRange.fromStartEnd(TIME_0930AM, TimeRange.END_OF_DAY, true));
